...
static class DeploymentController
{
	...
	public static void HandleDeploymentInput()
	{
		...
		if (SwinGame.MouseClicked(MouseButton.LeftButton)) {
			...
			//FIXME both the up/down buttons and the left/right buttons result in the orientation being set to left/right
	...
	private static void DoDeployClick()
	{
		...
		int row = 0;
		int col = 0;
		//FIXME Row calculation should be changed to account for the space above the grid to avoid a miscalculated row value
